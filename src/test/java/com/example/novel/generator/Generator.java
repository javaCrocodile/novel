...
public class Generator {
    ...
    private static final String USERNAME = "wxh";
    ...
    private static final String BASE_PACKAGE = "com.example.novel";
    ...
    private static final String DATABASE_PASSWORD = "wxh19981105";
